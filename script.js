...
var KZ = {
"m.title":"Астанада және Алматыда пәтер мен үйдің электр монтажы кілт тапсыру - Электросервис",
"m.desc":"Астанада және Алматыда кілт тапсыру электр монтажы: жаңа құрылыстағы пәтерлер, жеке үйлер, кеңселер. Сым тарту, электр қалқаны, розеткалар, жарықтандыру, HiTE PRO ақылды үй. 16 жыл тәжірибе, 5 жыл кепілдік, шарт, шебердің келуі мен смета тегін, Kaspi 0-0-12 бөліп төлеу.",
"m.ogt":"Астанада және Алматыда пәтер мен үйдің электр монтажы кілт тапсыру - Электросервис",
...
"h.kick":"Астана және Алматы · 16 жыл тәжірибе",
...
"u.k":"Қызметтер","u.h":"Электрика бойынша <em>керектің бәрі</em>","u.l":"Астанада, Алматыда және қала маңында жұмыс істейміз, 9:00-20:00, демалыссыз. Келу мен смета тегін.",
...
"c.ph":"Телефон · WhatsApp","c.ad":"Мекенжай","c.adv":"Астана, Ахмет Жұбанов көшесі, 24/1<small>Астана, Алматы және қала маңына шығамыз</small>","c.hr":"Кесте","c.hrv":"9:00-20:00<small>демалыссыз</small>","c.gis":"2ГИС-те ашу",
...
"ft.copy":"© 2026 Электросервис. Астана мен Алматыдағы электр монтажы.","ft.addr":"Астана, Ахмет Жұбанов көшесі, 24/1 · 9:00-20:00, демалыссыз",
"bar.call":"Қоңырау",
